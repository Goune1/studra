...
export default function AnimExam() {
  ...
  return (
    <div style={{ flex: 1, display: "flex", flexDirection: "column", gap: 12, padding: "8px 4px", justifyContent: "flex-end", position: "relative" }}>
      <div className="mono" style={{ fontSize: 10, color: "var(--ink-400)", textTransform: "uppercase", letterSpacing: ".14em" }}>Question 12 / 18</div>
      <div style={{ background: "#FAFAF9", border: "1px solid rgba(0,0,0,.06)", borderRadius: 10, padding: 12, display: "flex", flexDirection: "column", gap: 6 }}>
        <div style={{ fontSize: 12, color: "var(--ink-700)", lineHeight: 1.4 }}>La fonction f définie par f(x) = …</div>
        <div style={{ fontSize: 12, color: "var(--ink-700)", lineHeight: 1.4 }}>Étudier les variations de f sur ℝ.</div>
      </div>
      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
        <span className="mono" style={{ fontSize: 10, color: "var(--ink-500)" }}>Temps · {Math.floor(pct * 0.32)}min</span>
        {showGrade && (
