...
const CARDS = [
  { q: "Théorème de Pythagore", cat: "Maths" },
  { q: "Causes de la 1re GM", cat: "Histoire" },
  { q: "Acide carboxylique", cat: "Chimie" },
];
        ...
        return (
          <div key={i} style={{
            ...
            <div style={{ display: "flex", gap: 6 }}>
              <span className="mono" style={{ fontSize: 9, padding: "3px 8px", borderRadius: 999, background: "rgba(0,0,0,.05)", color: "var(--ink-500)", textTransform: "uppercase", letterSpacing: ".1em" }}>Dans 2j</span>
              <span className="mono" style={{ fontSize: 9, padding: "3px 8px", borderRadius: 999, background: "var(--accent-soft)", color: "var(--accent)", textTransform: "uppercase", letterSpacing: ".1em" }}>Bien</span>
            </div>
          </div>
        );
      })}
