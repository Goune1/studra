          ...
          >
            <div className="flex flex-col sm:flex-row sm:items-end gap-3 sm:gap-6">
              ...
              <div className="flex-1">
                <p className="text-base font-semibold text-white">{`Mention estimée : ${mentionLabels[calculation.mention]}`}</p>
                ...
                <p className="text-xs mt-2" style={{ color: 'var(--text-3)' }}>
                  {`Progression vers ${mentionLabels[progress.label as BacMention]}`}
                </p>
              </div>
            </div>
