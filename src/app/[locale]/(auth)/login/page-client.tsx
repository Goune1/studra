      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-8">
          <button
            ...
            className="w-full flex items-center justify-center gap-3 py-3 mb-6 bg-white hover:bg-gray-100 disabled:opacity-50 disabled:cursor-not-allowed rounded-xl text-gray-900 font-semibold transition-colors"
          >
        ...
        <p className="text-center mt-6 text-gray-400">
          {t('noAccount')}{' '}
          <Link href={{pathname: '/register', query: isPro ? {plan: 'pro'} : {}}} className="text-violet-400 hover:text-violet-300 transition-colors">
            {t('register')}
          </Link>
        </p>
      </div>
